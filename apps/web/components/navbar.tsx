...
export function NavBar() {
  ...
  return (
    ...
    <nav className="fixed w-full top-0 left-0 z-[99999] flex items-center rounded-none cursor-normal bg-gray-100 dark:bg-black justify-between px-4 py-[6px] text-primary-foreground">
      ...
      <div className="w-18 space-x-2  flex text-right items-center">
        <div className="flex items-center text-gray-700 dark:text-gray-200 max-sm:hidden space-x-2 justify-around">
          <div className="px-2 hover:text-blue-700 border-transparent transition-all border duration-300 border-y-4 hover:border-b-blue-700 p-2 cursor-pointer font-bold" 
